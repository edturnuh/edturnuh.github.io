...
export function ProjectCard({ project, revealDelay = 0, onClick }: ProjectCardProps) {
  return (
    <article
      className="group reveal-on-scroll cursor-pointer rounded-2xl border border-neutral-200 bg-white p-6 transition-colors duration-300 hover:border-neutral-300 hover:bg-neutral-50 focus-within:border-neutral-300 focus-within:ring-2 focus-within:ring-neutral-400 md:p-7"
      onClick={onClick}
      role="button"
      tabIndex={0}
      data-reveal
    ...
    >
      ...
      <h3 className="mt-6 text-[28px] leading-[1.15] tracking-[-0.03em] text-neutral-950 md:mt-6 md:text-[30px]">
        {project.client}
      </h3>
