      ...
      <div className="grid gap-8 md:grid-cols-[120px_minmax(0,1fr)] md:gap-10">
        ...
        <div className="max-w-3xl">
          ...
          <div className="body-copy mt-6 space-y-4 text-neutral-700">
            <p>I made my first website when I was 9 and I've been hooked ever since. After 8 years in marketing and digital acquisition – where I was always 'the website guy' as well – I decided to specialise. I'm now in my third year as a dedicated website manager / web product manager for high-impact public platforms.</p>
