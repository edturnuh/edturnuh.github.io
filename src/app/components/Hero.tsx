    ...
    <section className="pt-12 md:pt-20 pb-8 md:pb-10">
      <div className="max-w-4xl">
        ...
        <p className="page-enter page-enter-delay-4 body-copy max-w-3xl mt-6 text-neutral-700">
          Currently website manager at Allica Bank; I oversee the acquisition platform for a $1.2bn fintech, generating 10,000+ B2B leads annually. We're the fastest-growing firm in the UK (FT, 2025) and we just raised a Series-D (2026). As for my background:
        </p>
