    ...
    <>
      <section id="contact" className="py-20 md:py-28 border-t border-neutral-800">
        <div className="max-w-[620px]">
          <p className="font-mono text-[12px] md:text-[13px] uppercase tracking-wider text-neutral-500 mb-5">
            Next step
          </p>
          <h2 className="text-[32px] md:text-[40px] leading-[1.2] text-white mb-4">
            Got a problem worth solving?
          </h2>
          <p className="text-[16px] md:text-[17px] leading-[1.7] text-neutral-400 mb-8">
            I love working on interesting problems – including pro bono. If you think we'd work well together, please do get in touch.
          </p>
          <div className="flex flex-wrap items-center gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-xl bg-white/5 text-white text-[14px] md:text-[15px] border border-white/10 transition-all hover:bg-white/10 hover:border-white/20 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-black"
